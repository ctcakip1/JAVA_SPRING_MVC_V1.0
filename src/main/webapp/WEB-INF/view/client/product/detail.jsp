        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <head>
                    ...
                    <title>${product.name}-Clothershop</title>
                    <!-- Google Web Fonts -->
                                ...
                                <div>
                                    <nav aria-label="breadcrumd">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Chi tiet san pham
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-4">
                                                ...
                                                <ul class="list-unstyled fruite-categorie">
                                                    ...
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a href="#"><i class="fas fa-apple-alt me-2"></i>Gucci</a>
                                                            <span>(5)</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a href="#"><i
                                                                    class="fas fa-apple-alt me-2"></i>Burberry</a>
                                                            <span>(2)</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a href="#"><i class="fas fa-apple-alt me-2"></i>Louis
                                                                Vuitton</a>
                                                            <span>(8)</span>
                                                        </div>
                                                    </li>
